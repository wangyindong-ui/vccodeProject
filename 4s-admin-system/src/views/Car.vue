  ...
  <div class="car-list-view">
    ...
    <div class="chinese-card table-section">
      ...
      <el-table 
        ...
        v-loading="loading" 
        class="chinese-table"
        header-cell-class-name="chinese-th" 
        stripe
      >
        <!-- 固定列：品牌 -->
     ...
     <!-- 修改点：prop 改为 colorName -->
        ...
        <el-table-column label="操作" width="180" fixed="right">
          <template #default>
            <el-button link class="btn-link-primary">详情</el-button>
            <el-button link class="btn-link-gold">生成订单</el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button class="chinese-btn-vermilion-solid" @click="handleAdd">
...
import { getCarList, addCar } from '../utils/car'
// 移除了 Download 图标引入
...
.car-list-view {
  ...
  .search-form {
    ...
    :deep(.el-form-item) { margin-right: 20px; margin-bottom: 10px; }
  }
  
  .chinese-input { width: 180px; }
  ...
  .card-title-bar {
    ...
    padding-bottom: 10px;
    .title-text {
      font-weight: bold; color: $ink-black;
      font-family: 'Noto Serif SC', serif; font-size: 16px;
    }
  }

  .chinese-btn-vermilion {
    background-color: $vermilion; border-color: $vermilion; border-radius: 2px;
    font-family: 'Noto Serif SC';
    &:hover { background-color: darken($vermilion, 8%); }
  }
  .chinese-btn-default {
    border-radius: 2px;
    &:hover { color: $imperial-gold; border-color: $imperial-gold; background-color: #FEF9E7; }
  }
  .chinese-btn-gold {
    background-color: $imperial-gold; border-color: $imperial-gold; border-radius: 2px;
    font-family: 'Noto Serif SC';
    &:hover { background-color: darken($imperial-gold, 8%); }
  }
  ...
  .table-header {
    ...
    .section-title {
      font-size: 16px; font-weight: bold; color: $ink-black;
      border-left: 4px solid $vermilion; padding-left: 10px;
    }
  }
  ...
  :deep(.chinese-table) {
    ...
    .chinese-th {
      color: $ink-black; font-weight: bold;
    ...
    .el-table__body tr:hover .cell {
        color: $ink-black; font-weight: 600;
  ...
  .brand-text { font-family: 'Noto Serif SC', serif; font-weight: bold; color: $ink-black; }
  .price-text { color: $vermilion; font-weight: bold; font-family: 'Arial', sans-serif; }
  
  .stock-text { font-family: 'Arial', sans-serif; color: $ink-black; }
  .stock-text.low-stock { color: $vermilion; font-weight: bold; }
  ...
  .status-seal {
    display: inline-block; padding: 2px 8px; border: 2px solid; border-radius: 4px;
    font-family: 'LiSu', serif; font-size: 14px; transform: rotate(-5deg); font-weight: bold;
    &.seal-blue { color: #2980B9; border-color: #2980B9; }
    &.seal-red  { color: $vermilion; border-color: $vermilion; border-style: dashed; }
    &.seal-gray { color: #7F8C8D; border-color: #7F8C8D; border-style: dashed; }
  }

  .btn-link-primary { color: #34495E; font-weight: bold; &:hover { color: $vermilion; } }
  .btn-link-gold { color: $imperial-gold; font-weight: bold; }

  .pagination-wrapper {
    margin-top: 25px; display: flex; justify-content: center; position: relative; z-index: 1;
    :deep(.el-pagination.is-background .el-pager li.is-active) { background-color: $vermilion !important; }
  }

  .chinese-form-layout {
    padding: 0 20px;
    :deep(.el-input__wrapper), :deep(.el-select__wrapper), :deep(.el-input-number__wrapper) {
      box-shadow: none !important; border-bottom: 1px solid $ink-black !important; border-radius: 0;
      background-color: transparent; padding-left: 0;
      &:hover, &.is-focus { border-bottom-color: $imperial-gold !important; }
    }
    :deep(.el-input__inner) { font-family: 'Noto Serif SC', serif; color: $ink-black; }
    :deep(.el-form-item__label) { font-family: 'Noto Serif SC', serif; color: $ink-black; font-weight: bold; }
  }
  ...
  .cloud-pattern {
    ...
    &.top { margin-bottom: 20px; transform: rotate(180deg); }
    &.bottom { margin-top: 20px; }
  }

  .dialog-footer { text-align: center; padding-bottom: 10px; }
  .chinese-btn-default-plain {
    background: transparent !important; border: 1px solid $ink-black !important; color: $ink-black !important;
    font-family: 'Noto Serif SC', serif; border-radius: 2px;
    &:hover { background: rgba(0,0,0,0.05) !important; }
  }
  .chinese-btn-vermilion-solid {
    background-color: $vermilion !important; border-color: $vermilion !important; color: #fff !important;
    font-family: 'Noto Serif SC', serif; border-radius: 2px; letter-spacing: 1px; margin-left: 15px;
    &:hover { background-color: darken($vermilion, 10%) !important; }
  }
}
</style>
...
.chinese-dialog {
  .el-dialog__header {
    border-bottom: 1px solid rgba($imperial-gold, 0.3); margin-right: 0; text-align: center;
    .el-dialog__title {
      font-family: 'Noto Serif SC', serif; color: $ink-black; font-weight: bold; font-size: 18px;
    }
  }
...
.chinese-popper {
  .el-select-dropdown__item.selected {
    color: $vermilion !important; font-weight: bold; font-family: 'Noto Serif SC', serif;
  }
  .el-select-dropdown__item {
    font-family: 'Noto Serif SC', serif; color: $ink-black;
  }
}
</style>